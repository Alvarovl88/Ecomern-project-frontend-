...
const stripePromise = loadStripe("pk_test_51LQY9LEnUR15c2UM0mthZbHrYZgCkWZ5ojrQqAx8Ic1xkFiPYu9Yrpy5VJl9tziB5kPJTh1jQBslt41EfhjMiWdm00690pH1cK");
        ...
        <Container style={{ minHeight: "95vh" }} className="cart-container">
            <Row>
                <Col>
                    ...
                    {cart.length == 0 ? (
                        <Alert variant="info">Su compra se ha completado con exito. </Alert>
                    ) : (
