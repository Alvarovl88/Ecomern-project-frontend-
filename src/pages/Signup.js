                ...
                <Col md={6} className="signup__form--container">
                    <Form style={{ width: "100%" }} onSubmit={handleSignup}>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control type="email" placeholder="Introduce Email" value={email} required onChange={(e) => setEmail(e.target.value)} />
                        </Form.Group>
                        ...
                        <p className="pt-3 text-center">
                            No, ya tengo una cuenta <Link to="/login">Login</Link>{" "}
                        </p>
                    </Form>
                </Col>
