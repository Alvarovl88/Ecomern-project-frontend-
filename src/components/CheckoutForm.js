                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Nombre" value={user.name} disabled />
                        </Form.Group>
                    </Col>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                ...
                <Row>
                    ...
                    <Col md={5}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="País" value={country} onChange={(e) => setCountry(e.target.value)} required />
                        </Form.Group>
                    </Col>
                </Row>
